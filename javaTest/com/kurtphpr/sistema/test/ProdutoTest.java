...
public class ProdutoTest extends TestHeranca{
	...
	public void setup(){ //Esse método prepara a base para efetuar os teste;
		...
		Produto prodTest01 = new Produto("Produto teste 001", "UN", new Date(), 30, 2.5f);
		Produto prodTest02 = new Produto("Produto teste 002", "LT", new Date(), 45, 3.6f);
		Produto prodTest03 = new Produto("Produto teste 003", "KG", new Date(), 25, 4.3f);
	...
	public void alteracaoProdutoTest(){
		...
		Query consulta = pesquisar("003");
		
		Produto produtoAlterado = (Produto) consulta.uniqueResult();   //Pesquisa o produto 003;
		produtoAlterado.setEstoque(100);							  //Altera o valor do estoque do produto 003;
